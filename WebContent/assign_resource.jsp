...
<header>
	...
	<div id = "hd2">
		...
		<div id = "hd2s3"><h1 style = "color: #ACE500">Assign resources here</h1></div>
...
<div style = "height: 100%; width: 100%; float: top; text-align: center;">
	...
	<br/>
		...
		<h2>Work Id: <input type = "text" name = "wid"/>
		</h2><br/>	
		
		<h2>Teacher Id: <input type = "text" name = "tid"/>
		</h2><br/>
		
		<h2>Position:
		<select id = "position" name = "pos" onchange = "showHint(this.value)">
		...
		<h2>Class Id: <span id="txtHint"></span>
		</h2><br/>
