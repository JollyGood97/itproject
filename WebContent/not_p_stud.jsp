...
<title>Notice to a particular student</title>
...
<header>
	...
	<div id = "hd2">
		...
		<div id = "hd2s3"><h1 style = "color: #ACE500">Send to a particular student</h1></div>
	</div>
	<br/>
</header>
<!-- Header section end -->
...
<div style = "height: 100%; width: 100%; float: top;">
	...
	<form action = "send_notice.jsp?id=<%=id%>" method = "post">
		<h2>Student's id : <input type = "text" name = "stid" required/> <br/></h2>
		<h2>Description : <textarea name = "desc" required></textarea> <br/></h2>
