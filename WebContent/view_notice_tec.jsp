...
<header>
	...
	<div id = "hd2">
		...
		<div id = "hd2s3"><h1 style = "color: #ACE500">View Notice</h1></div>
	</div>
	<br/>
</header>
<!-- Header section end -->
...
<div style = "height: 100%; width: 100%; float: top;">
	...
	<br/>
		<a href = "com_tec_not.jsp" class = "link_col"><img src="assests/image/b.png" height = "30" width = "30">&nbsp;&nbsp;&nbsp;Common Notice</a><br/>
		<a href = "pat_tec_not.jsp" class = "link_col"><img src="assests/image/a.png" height = "30" width = "30">&nbsp;&nbsp;&nbsp;Particular Notice</a><br/>
	</div>
</div>
<!-- Mid section end -->
