...
<title>Notice to all students teacher</title>
...
<header>
	...
	<div id = "hd2">
		...
		<div id = "hd2s3"><h1 style = "color: #ACE500">Notice to all common students</h1></div>
	</div>
	<br/>
</header>
<!-- Header section end -->
...
<%
	...
	ResultSet rs=st.executeQuery("select * from `send_to` where s_com = '1' ORDER BY nid DESC");
